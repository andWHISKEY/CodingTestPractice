...
# FROM CAR_RENTAL_COMPANY_RENTAL_HISTORY
# WHERE '2022-11-01'<=START_DATE<='2022-11-30' or '2022-11-01'<=END_DATE<='2022-11-30'  
# )

# -- 코드를 입력하세요
# SELECT *
# FROM CAR_RENTAL_COMPANY_CAR as CAR LEFT OUTER JOIN A on CAR.CAR_ID=A.CAR_ID
# WHERE A.CAR_ID is null and CAR.CAR_TYPE in ('세단','SUV')